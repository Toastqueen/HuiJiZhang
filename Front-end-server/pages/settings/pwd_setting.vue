	...
	<view class="box">
		...
		<view class="" style="background-color: white;padding: 10px;">
			...
			<view class="uni-form-item uni-column" style="margin-top: 16px;">
				<input type="number" v-model="info.tel" class="uni-input" name=""/>
			</view>
			...
			<view class="uni-form-item uni-column" style="margin-top: 16px;">
				<input type="text" v-model="info.pwd" class="uni-input" name="" placeholder="请输入密码" />
			</view>
...
<script>
	export default {
		...
		onShow() {
			this.info.tel = this.$store.state.user.info.phoneNumber
		},
		methods: {
			goBack(){
				uni.navigateBack()
